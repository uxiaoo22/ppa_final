...
```{r}
evictions_raw <- read.csv("/Users/cathy/GitHub/ppa_final/data/philadelphia_weekly_2020_2021.csv")
...
### Property Data
```{r}
opa <- read_csv("/Users/cathy/GitHub/ppa_final/data/opa_properties_public.csv")
```
```{r}
# spatial join
opa_xy <- opa %>%
...
transit_raw <- read_csv("/Users/cathy/GitHub/ppa_final/data/Transit_Stops.csv")
...
```
```{r}
crime <- read_csv("/Users/cathy/GitHub/ppa_final/data/incidents_part1_part2.csv")
